...
public class LeggingsBlastPlan extends IEnchantmentPlan {

    @Override
    public List<RegistryKey<Enchantment>> RequiredBooks() {
        return List.of(BLAST_PROTECTION, UNBREAKING, MENDING);
    }

    @Override
    public List<Pair<Integer, Integer>> Plan() {
        return List.of(
            /* Step 0 */   new Pair<>(initialItemID(),    bookID(BLAST_PROTECTION))
